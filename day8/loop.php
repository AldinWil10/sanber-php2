...
<body>
    ...
    */
    ...
    for ($a = 0; $a < count($numbers); $a++) {
        $hasil_bagi = $numbers[$a] % 5;
        echo "<br> Indeks ke [$a] Array sisa baginya adalah: " . $hasil_bagi;
    }
    ?>
    <hr>
    <?php
    ...
    */
    ...
    foreach ($items as $item) {
        ...
        echo "Array ( [id] => " . $assoc_item['id'] . " [name] => " . $assoc_item['name'] . " [price] => " . $assoc_item['price'] . " [description] => " . $assoc_item['description'] . " [source] => " . $assoc_item['source'] . " )<br>";
    }
    ?>
    <hr>
    <?php
